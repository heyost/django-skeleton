...
Skeleton for fresh Django project, based on https://github.com/ITNG/django-skeleton with some improvement and PEP8 compliant for Django 1.11. Should work with either Python 3.5+ or 2.7 (3.5 is preferred)
